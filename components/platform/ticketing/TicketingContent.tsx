    ...
    <div className="ed-ticketing">
      ...
      <section className="relative w-full overflow-hidden" style={{ backgroundColor: PL.base }}>
        ...
        <motion.div
          ...
          className="ed-hero-pad relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 md:px-12 lg:px-16 py-20 md:py-24 lg:grid-cols-[1.08fr_.92fr] lg:gap-14"
        >
