          ...
          {articles.map(({ icon: Icon, label, title, cta, href }, i) => (
            ...
            >
              <a
                ...
                className="group flex flex-col h-full rounded-2xl border border-[#E5E7EB] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,0,0,0.09)]"
              >
                ...
                <p
                  className="text-sm font-semibold leading-snug text-[#0A0A0A] flex-1 mb-4 group-hover:text-[#00AEEF] transition-colors"
