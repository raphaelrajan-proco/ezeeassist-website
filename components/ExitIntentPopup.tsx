    ...
    <AnimatePresence>
      {show && (
        <>
          ...
          >
            <div className="relative w-full max-w-lg rounded-2xl bg-white shadow-[0_24px_80px_rgba(0,0,0,0.18)] overflow-hidden">
              {/* Close */}
              <button
                onClick={handleDismiss}
                className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E7EB] bg-white text-gray-400 hover:text-gray-700 transition-colors"
                aria-label="Close"
              >
                <X size={15} />
              </button>
              ...
              <div className="p-8">
                {submitted ? (
                  <div className="text-center py-4">
                    <p className="text-xl font-bold text-[#0A0A0A] mb-2">On its way! 📬</p>
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-[#0A0A0A] mb-1">Company Name *</label>
