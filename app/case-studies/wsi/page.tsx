...
export const metadata: Metadata = {
  title: "WSI: 67% Support Reduction with AI",
  description:
    "How WSI, the world's largest digital marketing franchise, reduced support questions by 67% with EZee Assist.",
  alternates: { canonical: "/case-studies/wsi" },
};
...
const caseStudySchema = {
  ...
  description:
    "How WSI, the world's largest network of digital marketing consultants, reduced repetitive franchisee support questions by 67% using EZee Assist's AI-powered platform.",
  publisher: { "@type": "Organization", name: "EZee Assist" },
  about: {
    "@type": "Organization",
    name: "WSI",
    description: "World's largest network of digital marketing consultants",
  },
};
...
const data = {
  ...
  results_text:
    "Within months of deployment, WSI saw a 67% reduction in repetitive support questions reaching their human team. Franchisees in every time zone now had 24/7 access to accurate brand knowledge — no more waiting for the support team to come online. FBCs were freed to focus on coaching, relationship building, and strategic initiatives instead of answering the same questions repeatedly.",
  quote:
