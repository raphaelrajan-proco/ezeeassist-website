          ...
          <motion.div {...fadeUp(0)}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              {communityPartners.map((name) => (
                <div key={name} className="flex items-center justify-center rounded-xl border border-[#E5E7EB] dark:border-white/[0.08] bg-white dark:bg-[#161616] px-6 py-3 shadow-sm dark:shadow-none">
