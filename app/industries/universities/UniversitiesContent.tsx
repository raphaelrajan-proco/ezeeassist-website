        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-28">
          <div className="grid grid-cols-1 gap-14 items-center lg:grid-cols-2">
            <motion.div {...fadeUp(0)}>
              ...
              <h2 className="text-4xl font-bold tracking-tight text-[#0A0A0A] sm:text-5xl mb-7" style={{ letterSpacing: "-0.02em" }}>
            ...
            <motion.div {...fadeUp(0.15)} className="flex flex-col gap-5">
              {[
                ...
                <div key={stat} className="flex items-center gap-5 rounded-2xl border border-[#E5E7EB] bg-[#F7F8FA] px-7 py-5">
