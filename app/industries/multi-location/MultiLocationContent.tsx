        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-28">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {segments.map(({ icon: Icon, label }, i) => (
              <motion.div key={label} {...fadeUp(i * 0.08)} className="card-hover flex items-center gap-4 rounded-2xl border border-[#E5E7EB] bg-white px-8 py-6 shadow-sm">
                ...
                <span className="text-base font-semibold text-[#0A0A0A]">{label}</span>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-28">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {benefits.map(({ icon: Icon, title, body }, i) => (
              <motion.div key={title} {...fadeUp(i * 0.1)} className="card-hover group relative overflow-hidden rounded-2xl border border-[#E5E7EB] bg-[#F7F8FA] p-8">
