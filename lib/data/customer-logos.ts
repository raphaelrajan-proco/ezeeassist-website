...
export interface CustomerLogo {
  ...
  ar?: number;
  /**
   * The art has an opaque background rather than a transparent one.
   * **Measured, not guessed** (under 15% fully-clear pixels).
   *
   * It only matters on dark surfaces. There the transparent marks take a
   * white-silhouette filter and read cleanly, while these would become
   * solid rectangles, so they get a light plate behind them instead. On
   * light surfaces nothing is needed either way: a white background is
   * invisible on white.
   *
   * **This flag is a stopgap for missing art, not a design choice.** 26
   * of 50 files are like this, including four JPGs. Replacing a file with
   * a transparent PNG and deleting its flag is the real fix, and it is
   * the one thing that makes the dark-mode strip look right.
   */
  opaque?: true;
}
...
export const customerLogos: CustomerLogo[] = [
  ...
  { name: "Bumble Bee Blinds", src: "/logos/brands/bumble-bee-blinds.png", alt: "Bumble Bee Blinds", ar: 1.43, opaque: true },
  { name: "Wisdom Senior Care", src: "/logos/brands/wisdom-senior-care.png", alt: "Wisdom Senior Care", ar: 2.64, opaque: true },
  { name: "The DRIPBaR", src: "/logos/brands/the-dripbar.png", alt: "The DRIPBaR", ar: 1.56, opaque: true },
  { name: "New Creations", src: "/logos/brands/new-creations.png", alt: "New Creations", ar: 7.59, opaque: true },
  { name: "Athletic Republic", src: "/logos/brands/athletic-republic.png", alt: "Athletic Republic", ar: 1.00, opaque: true },

  // ── Featured run, order requested ────────────────────────────
  { name: "UPS Store", src: "/logos/brands/ups-store.png", alt: "The UPS Store", ar: 5.89 },
  { name: "Sport Clips", src: "/logos/brands/sport-clips.jpg", alt: "Sport Clips", ar: 3.33, opaque: true },
  ...
  { name: "DivaDance", src: "/logos/brands/divadance.png", alt: "DivaDance", ar: 1.00, opaque: true },
  { name: "Deka Lash", src: "/logos/brands/deka-lash.png", alt: "Deka Lash", ar: 1.00 },
  { name: "HorsePower Brands", src: "/logos/brands/horsepower-brands.png", alt: "HorsePower Brands", ar: 2.53, opaque: true },
  { name: "Oasis Senior Advisors", src: "/logos/brands/oasis-senior-advisors.png", alt: "Oasis Senior Advisors", ar: 1.49, opaque: true },
  ...
  { name: "QC Kinetix", src: "/logos/brands/qc-kinetix.png", alt: "QC Kinetix", ar: 4.03, opaque: true },
  { name: "WSI", src: "/logos/brands/wsi.png", alt: "WSI", ar: 2.40, opaque: true },
  ...
  { name: "Zoom Drain", src: "/logos/brands/zoom-drain.png", alt: "Zoom Drain", ar: 1.80, opaque: true },
  { name: "Heights Wellness", src: "/logos/brands/heights-wellness-retreat.png", alt: "Heights Wellness Retreat", ar: 1.91, opaque: true },
  ...
  { name: "Corporate Cleaning Group", src: "/logos/brands/corporate-cleaning-group.jpg", alt: "Corporate Cleaning Group", ar: 4.13, opaque: true },
  { name: "Egg Bred", src: "/logos/brands/egg-bred.png", alt: "Egg Bred", ar: 2.94 },
  { name: "Fresh Burger", src: "/logos/brands/fresh-burger.jpg", alt: "Fresh Burger", ar: 1.90, opaque: true },
  { name: "Garage Floors 4 Less", src: "/logos/brands/garage-floors-4-less.png", alt: "Garage Floors 4 Less", ar: 1.00 },
  { name: "Gatsby Glass", src: "/logos/brands/gatsby-glass.png", alt: "Gatsby Glass", ar: 5.24, opaque: true },
  ...
  { name: "GradePower Learning", src: "/logos/brands/gradepower-learning.png", alt: "GradePower Learning", ar: 2.18, opaque: true },
  ...
  { name: "Home Clean Heroes", src: "/logos/brands/home-clean-heroes.png", alt: "Home Clean Heroes", ar: 1.90, opaque: true },
  { name: "Home Run Franchises", src: "/logos/brands/home-run-franchises.png", alt: "Home Run Franchises", ar: 2.64, opaque: true },
  { name: "iFOAM", src: "/logos/brands/ifoam.png", alt: "iFOAM", ar: 3.09, opaque: true },
  { name: "Massage Heights", src: "/logos/brands/massage-heights.png", alt: "Massage Heights", ar: 1.40, opaque: true },
  { name: "MAX Strength Fitness", src: "/logos/brands/max-strength-fitness.png", alt: "MAX Strength Fitness", ar: 1.00 },
  { name: "Mighty Dog Roofing", src: "/logos/brands/mighty-dog-roofing.png", alt: "Mighty Dog Roofing", ar: 1.49, opaque: true },
  { name: "Nani's Gelato", src: "/logos/brands/nanis-gelato.png", alt: "Nani's Gelato", ar: 1.50, opaque: true },
  ...
  { name: "PMI", src: "/logos/brands/pmi.png", alt: "PMI", ar: 2.65, opaque: true },
  ...
  { name: "Up Closets", src: "/logos/brands/up-closets.png", alt: "Up Closets", ar: 2.23, opaque: true },
  { name: "Fuzz Wax Bar", src: "/logos/brands/waxbar-fuzz.jpg", alt: "Fuzz Wax Bar", ar: 1.00, opaque: true },
];
